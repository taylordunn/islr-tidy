...
A straightforward approach of predicing a quantiative $Y$ from a single predictor $X$, assuming an approximately linear relationship:
...
# Since I will be reproducting this table often, write a function
