...
```{r figure7.1, warning=FALSE, fig.cap="Figure 7.1"}
wage <- ISLR2::Wage
...
```{r figure7.2, fig.cap="Figure 7.2", warning=FALSE}
...
```{r figure7.8, fig.cap="Figure 7.8"}
...
The figure was re-produced here: \@ref(fig: figure7.1).
...
The step function was fit and visualized here: \@ref(fig: figure7.2).

### Splines

The smoothing spline fits are shown here: \@ref(fig: figure7.8).
...
https://community.rstudio.com/t/tune-grid-and-gam-model-incl-gam-formula/127206/2
